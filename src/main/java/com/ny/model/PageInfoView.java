...
@ApiModel(value = "分页信息")
public class PageInfoView<T> extends PageSerializableView<T> {
     ...
     * @param list
     */
    public PageInfoView(List<T> list) {
        this(list, 8);
    }
     ...
     */
    public PageInfoView(List<T> list, int navigatePages) {
        super(list);
    ...
    public static <T> PageInfoView<T> of(List<T> list) {
        return new PageInfoView<T>(list);
    }

    public static <T> PageInfoView<T> of(List<T> list, int navigatePages) {
        return new PageInfoView<T>(list, navigatePages);
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("PageInfoView{");
