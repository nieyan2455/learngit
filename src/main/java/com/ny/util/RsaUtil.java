...
public class RsaUtil {
    ...
    public static KeyPair generateKeyPair() {
        try {
            keyPairGen.initialize(KEY_SIZE, new SecureRandom(DateUtil.getCurrentDateTime().getBytes()));
            /* 缓存的密钥对。 */
     ...
     * @return 原文字符串。
     */
    private static String decryptString(String encrypttext, RSAPrivateKey privateKey) {
